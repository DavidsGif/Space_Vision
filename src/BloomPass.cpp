...
namespace itg
{
    ...
    void BloomPass::render(ofFbo& readFbo, ofFbo& writeFbo)
    {
        ...
        // clear as color(0,0,0)
        ofClear(0, 0, 0, 255);
        
        // set color as (255, 255, 255)
        ofSetColor(255, 255, 255);
        readFbo.draw(0, 0);
        ofEnableAlphaBlending();
        glBlendFunc(GL_ONE, GL_ONE);
        
        // draw using writeFbo's width and height
